...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    ...
    const pages = [
      {id: 'intro',
        tagline: 'FIND YOUR JOB',
        title: 'How It Works?',
        description: 'All you need to do right now is CREATE YOUR ACCOUNT!',
      },
      {id: 'clients',
        tagline: 'PARTNERS',
        title: 'Companies that use our platform',
        description: 'These companies use our platform to post their job vacancies. They believe they get the best employee from VIBGYOR.',
      },
      {id: 'services',
        tagline: 'BELIEVING',
      ...
      {id: 'testimonials',
        tagline: 'FEEDBACK OF PLACED STUDENTS',
      ...
      {id: 'footer',
        ...
        developer: 'Priyanka Bhutani',
        developerlink: 'https://bhutanipriyanka.wordpress.com',
      },
      {id: 'blog',
        tagline: 'My thoughts',
      ...
      {id: 'header',
        heading: 'Find Your Opportunity',
        headingtext: 'Here you can find the best opportunities for you All you need to do is REGISTER!',
    ...
    const features = [
      {id: 1, icon: 'user-plus', title: 'Create Account',
      description: 'Buckle Up Your Belts! After registering here,You will get various opportunities to get hired in your desired Company.'},
      {id: 2, icon: 'address-card', title: 'Portfolio',
      description: 'Create you impressive portfolio, so that every company should step-forward to hire you in their Company.'},
      {id: 3, icon: 'search', title: 'Search You Expertise',
      description: 'Once you create your portfolio, you are able to search jobs in your expertise.'},
      {id: 4, icon: 'trophy', title: 'Apply',
      description: 'Apply for your favourite company and job profile, and get hired by them!'},
  ];
  ...
  const images = [
    ...
    const menu = [
      ...
      {id: 6, title: 'Companies', link: '/clients', outlet: ''},
  ...
  const companies = [
    {id: 1 , name: 'Capgemini', weblink: 'capgem.jpg', logo: 'capgem.jpg'},
    {id: 7 , name: 'Intel', weblink: 'intel.gif', logo: 'intel.gif'},
    {id: 3 , name: 'Cisco', weblink: 'cisco.png', logo: 'cisco.png'},
    {id: 4 , name: 'IBM', weblink: 'ibm.png', logo: 'ibm.png'},
    {id: 8 , name: 'Microsoft', weblink: 'microsoft.png', logo: 'microsoft.png'},
    {id: 6 , name: 'Google', weblink: 'google.png', logo: 'google.png'},


];
const feedbacks = [
  {id: 1 , name: 'John Doe', userimage: 'user-1.jpg',
  comments: 'Because of this website, today I am Working for my desired company',
  company: 'Google'},
  ...
  comments: 'I really love to be a part of this platform',
  company: 'IBM'},
];
